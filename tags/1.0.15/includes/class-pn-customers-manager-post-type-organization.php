...
class PN_CUSTOMERS_MANAGER_Post_Type_organization {
   ...
   * @return string
   */
  public static function pn_customers_manager_render_contacts_list_public($organization_id) {
    return self::pn_customers_manager_render_contacts_list($organization_id);
  }
  ...
  public function pn_cm_organization_list_wrapper() {
    // Only CRM managers and administrators can access organizations.
      ...
      <div class="pn-customers-manager-cpt-list pn-customers-manager-pn_cm_organization-list pn-customers-manager-mb-50">
        <div class="pn-customers-manager-cpt-search-container pn-customers-manager-mb-20 pn-customers-manager-text-align-right">
          <div class="pn-customers-manager-cpt-search-wrapper">
            <?php if (current_user_can('edit_pn_cm_organization')): ?>
              <a href="#" id="pn-cm-csv-import-trigger" class="pn-customers-manager-text-decoration-none pn-customers-manager-p-10" title="<?php esc_attr_e('Import CSV', 'pn-customers-manager'); ?>">
                <i class="material-icons-outlined pn-customers-manager-cursor-pointer pn-customers-manager-font-size-30 pn-customers-manager-vertical-align-middle pn-customers-manager-tooltip" title="<?php esc_attr_e('Import CSV', 'pn-customers-manager'); ?>">upload_file</i>
              </a>
            <?php endif; ?>
    ...
    <?php
    if (class_exists('PN_CUSTOMERS_MANAGER_Csv_Import')) {
      PN_CUSTOMERS_MANAGER_Csv_Import::pn_customers_manager_csv_render_frontend();
    }
    ?>
    <?php
      ...
      <ul class="pn-customers-manager-organizations pn-customers-manager-list-style-none pn-customers-manager-p-0 pn-customers-manager-margin-auto">
        <?php if (!empty($organization)): ?>
          <?php foreach ($organization as $organization_id):
            $org_email   = get_post_meta($organization_id, 'pn_cm_organization_email', true);
            $org_phone   = get_post_meta($organization_id, 'pn_cm_organization_phone', true);
            $org_address = get_post_meta($organization_id, 'pn_cm_organization_address', true);
            $org_city    = get_post_meta($organization_id, 'pn_cm_organization_city', true);
            $org_region  = get_post_meta($organization_id, 'pn_cm_organization_region', true);
            $org_postal  = get_post_meta($organization_id, 'pn_cm_organization_postal_code', true);
            $org_country = get_post_meta($organization_id, 'pn_cm_organization_country', true);
            $org_full_address = implode(', ', array_filter([$org_address, $org_postal, $org_city, $org_region, $org_country]));
          ?>
              ...
              <div class="pn-customers-manager-display-table pn-customers-manager-width-100-percent">
                ...
                <div class="pn-customers-manager-display-inline-table pn-customers-manager-width-20-percent pn-customers-manager-text-align-right pn-customers-manager-position-relative">
                  <?php if (!empty($org_email)): ?>
                    <i class="material-icons-outlined pn-customers-manager-list-action-icon pn-customers-manager-btn-copy pn-customers-manager-tooltip" data-pn-customers-manager-copy-text="<?php echo esc_attr($org_email); ?>" title="<?php echo esc_attr($org_email); ?>" data-tooltip="<?php echo esc_attr($org_email); ?>">email</i>
                  <?php endif; ?>
                  <?php if (!empty($org_phone)): ?>
                    <i class="material-icons-outlined pn-customers-manager-list-action-icon pn-customers-manager-btn-copy pn-customers-manager-tooltip" data-pn-customers-manager-copy-text="<?php echo esc_attr($org_phone); ?>" title="<?php echo esc_attr($org_phone); ?>" data-tooltip="<?php echo esc_attr($org_phone); ?>">phone</i>
                  <?php endif; ?>
                  <?php if (!empty($org_full_address)): ?>
                    <i class="material-icons-outlined pn-customers-manager-list-action-icon pn-customers-manager-btn-copy pn-customers-manager-tooltip" data-pn-customers-manager-copy-text="<?php echo esc_attr($org_full_address); ?>" title="<?php echo esc_attr($org_full_address); ?>" data-tooltip="<?php echo esc_attr($org_full_address); ?>">location_on</i>
                  <?php endif; ?>
