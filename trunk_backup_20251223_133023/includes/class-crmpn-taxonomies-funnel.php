...
class CUSTOMERS_MANAGER_PN_Taxonomies_Funnel { 
	...
	public static function customers_manager_pn_register_taxonomies() {
		$taxonomies = [
			'customers_manager_pn_funnel_category' => [
	  ...
	  foreach ($taxonomies as $taxonomy => $options) {
	  	$labels = [
			...
			register_taxonomy($taxonomy, 'customers_manager_pn_funnel', $args);
			register_taxonomy_for_object_type($taxonomy, 'customers_manager_pn_funnel');
		}
	}
}