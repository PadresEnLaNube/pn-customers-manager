...
class CUSTOMERS_MANAGER_PN_Deactivator {
	...
	public static function customers_manager_pn_deactivate() {
      ...
      $customers_manager_pn_funnel = get_posts(['fields' => 'ids', 'numberposts' => -1, 'post_type' => 'customers_manager_pn_funnel', 'post_status' => 'any', ]);

      if (!empty($customers_manager_pn_funnel)) {
        foreach ($customers_manager_pn_funnel as $post_id) {
