...
class CUSTOMERS_MANAGER_PN {
	...
	private function customers_manager_pn_define_common_hooks() {
		...
		$this->customers_manager_pn_loader->customers_manager_pn_add_action('customers_manager_pn_funnel_form_save', $plugin_post_type_funnel, 'customers_manager_pn_funnel_form_save', 999, 5);

		$plugin_post_type_organization = new CUSTOMERS_MANAGER_PN_Post_Type_organization();
		$this->customers_manager_pn_loader->customers_manager_pn_add_action('customers_manager_pn_organization_form_save', $plugin_post_type_organization, 'customers_manager_pn_organization_form_save', 999, 5);
	}
	...
	private function customers_manager_pn_define_custom_post_types() {
		$plugin_post_type_funnel = new CUSTOMERS_MANAGER_PN_Post_Type_Funnel();
		$this->customers_manager_pn_loader->customers_manager_pn_add_action('init', $plugin_post_type_funnel, 'customers_manager_pn_funnel_register_post_type');
		$this->customers_manager_pn_loader->customers_manager_pn_add_action('admin_init', $plugin_post_type_funnel, 'customers_manager_pn_funnel_add_meta_box');
		$this->customers_manager_pn_loader->customers_manager_pn_add_action('save_post_customers_manager_pn_funnel', $plugin_post_type_funnel, 'customers_manager_pn_funnel_save_post', 10, 3);
		$this->customers_manager_pn_loader->customers_manager_pn_add_filter('single_template', $plugin_post_type_funnel, 'customers_manager_pn_funnel_single_template', 10, 3);
		$this->customers_manager_pn_loader->customers_manager_pn_add_filter('archive_template', $plugin_post_type_funnel, 'customers_manager_pn_funnel_archive_template', 10, 3);
		$this->customers_manager_pn_loader->customers_manager_pn_add_shortcode('customers-manager-pn-funnel-list', $plugin_post_type_funnel, 'customers_manager_pn_funnel_list_wrapper');

		$plugin_post_type_organization = new CUSTOMERS_MANAGER_PN_Post_Type_organization();
		$this->customers_manager_pn_loader->customers_manager_pn_add_action('init', $plugin_post_type_organization, 'customers_manager_pn_organization_register_post_type');
		$this->customers_manager_pn_loader->customers_manager_pn_add_action('admin_init', $plugin_post_type_organization, 'customers_manager_pn_organization_add_meta_box');
		$this->customers_manager_pn_loader->customers_manager_pn_add_action('save_post_customers_manager_pn_organization', $plugin_post_type_organization, 'customers_manager_pn_organization_save_post', 10, 3);
		$this->customers_manager_pn_loader->customers_manager_pn_add_filter('single_template', $plugin_post_type_organization, 'customers_manager_pn_organization_single_template', 10, 3);
		$this->customers_manager_pn_loader->customers_manager_pn_add_filter('archive_template', $plugin_post_type_organization, 'customers_manager_pn_organization_archive_template', 10, 3);
		$this->customers_manager_pn_loader->customers_manager_pn_add_shortcode('customers-manager-pn-organization-list', $plugin_post_type_organization, 'customers_manager_pn_organization_list_wrapper');
	}
	...
	private function customers_manager_pn_load_settings() {
		...
		$this->customers_manager_pn_loader->customers_manager_pn_add_filter('plugin_action_links_crmpn/crmpn.php', $plugin_settings, 'customers_manager_pn_plugin_action_links');
	}
	...
	private function customers_manager_pn_load_shortcodes() {
		...
		$this->customers_manager_pn_loader->customers_manager_pn_add_shortcode('customers-manager-pn-funnel', $plugin_shortcodes, 'customers_manager_pn_funnel');
	...
	private function customers_manager_pn_define_client_hooks() {
		...
		$this->customers_manager_pn_loader->customers_manager_pn_add_action('customers_manager_pn_form_save', $client_form, 'handle_form_save', 10, 4);
	}
