(function($) {
  ...
  $(document).ready(function() {
    ...
    $(document).on('submit', '.customers-manager-pn-form', function(e){
      ...
      var customers_manager_pn_form = $(this);
      var customers_manager_pn_btn = customers_manager_pn_form.find('input[type="submit"]');
      
      console.log('CRMPN AJAX - Form found:', customers_manager_pn_form.attr('id'), 'Submit button:', customers_manager_pn_btn.length);
      ...
      console.log('Form submitted:', customers_manager_pn_form.attr('id'));
      ...
      var data = {
        ...
        customers_manager_pn_ajax_nopriv_type: 'customers_manager_pn_form_save',
        customers_manager_pn_form_id: customers_manager_pn_form.attr('id'),
        customers_manager_pn_form_type: customers_manager_pn_btn.attr('data-customers-manager-pn-type'),
        customers_manager_pn_form_subtype: customers_manager_pn_btn.attr('data-customers-manager-pn-subtype'),
        customers_manager_pn_form_user_id: customers_manager_pn_btn.attr('data-customers-manager-pn-user-id'),
        customers_manager_pn_form_post_id: customers_manager_pn_btn.attr('data-customers-manager-pn-post-id'),
        customers_manager_pn_form_post_type: customers_manager_pn_btn.attr('data-customers-manager-pn-post-type'),
      ...
      $(customers_manager_pn_form.find('input:not([type="submit"]), select, textarea')).each(function(index, element) {
      ...
      $.post(ajax_url, data, function(response) {
        ...
        if (response_json['error_key'] == 'customers_manager_pn_form_save_error_unlogged') {
        ...
        if (response_json['update_list'] && response_json['update_html']) {
          ...
          var list_selector = '.customers-manager-pn-cpt-list-wrapper.customers-manager-pn-' + data.customers_manager_pn_form_post_type + '-list-wrapper';
          if (!$(list_selector).length) {
            // Fallback: try without the cpt-list-wrapper prefix
            list_selector = '.customers-manager-pn-' + data.customers_manager_pn_form_post_type + '-list-wrapper';
          }
        ...
        if (response_json['check'] == 'post_check') {
          CUSTOMERS_MANAGER_PN_Popups.close();
          $('.customers-manager-pn-menu-more-overlay').fadeOut('fast');
          $('.customers-manager-pn-' + data.customers_manager_pn_form_post_type + '-list-item[data-' + data.customers_manager_pn_form_post_type + '-id="' + data.customers_manager_pn_form_post_id + '"] .customers-manager-pn-check-wrapper i').text('task_alt');
        }else if (response_json['check'] == 'post_uncheck') {
          CUSTOMERS_MANAGER_PN_Popups.close();
          $('.customers-manager-pn-menu-more-overlay').fadeOut('fast');
          $('.customers-manager-pn-' + data.customers_manager_pn_form_post_type + '-list-item[data-' + data.customers_manager_pn_form_post_type + '-id="' + data.customers_manager_pn_form_post_id + '"] .customers-manager-pn-check-wrapper i').text('radio_button_unchecked');
        }
    ...
    $(document).on('click', '.customers-manager-pn-popup-open-ajax', function(e) {
      ...
      var customers_manager_pn_funnel_id = customers_manager_pn_btn.closest('.customers-manager-pn-funnel').attr('data-customers_manager_pn_funnel-id') || customers_manager_pn_btn.attr('data-customers_manager_pn_funnel-id') || '';
      var customers_manager_pn_organization_id = customers_manager_pn_btn.closest('.customers-manager-pn-organization').attr('data-customers_manager_pn_organization-id') || customers_manager_pn_btn.closest('.customers-manager-pn-customers_manager_pn_organization-list-item').attr('data-customers_manager_pn_organization-id') || customers_manager_pn_btn.attr('data-customers_manager_pn_organization-id') || '';
      ...
      CUSTOMERS_MANAGER_PN_Popups.open(customers_manager_pn_popup_element, {
        beforeShow: function(instance, popup) {
          ...
          var data = {
            ...
            customers_manager_pn_get_nonce: customers_manager_pn_action.customers_manager_pn_get_nonce,
            customers_manager_pn_funnel_id: customers_manager_pn_funnel_id ? customers_manager_pn_funnel_id : '',
            customers_manager_pn_organization_id: customers_manager_pn_organization_id ? customers_manager_pn_organization_id : '',
          };
    ...
    var customers_manager_pn_cpts_mapping = {
      'customers_manager_pn_funnel': 'customers_manager_pn_funnel',
      'customers_manager_pn_organization': 'customers_manager_pn_organization'
    };
