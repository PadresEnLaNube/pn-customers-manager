...
class CRMPN_Functions_Post {
	 ...
	 * @since    1.0.0
	 */
	public function crmpn_insert_post($title, $content, $excerpt, $name, $type, $status, $author = 1, $parent = 0, $cats = [], $tags = [], $postmeta = [], $overwrite_id = true) {
    $post_values = [
   ...
   */
  public function crmpn_duplicate_post($post_id, $post_status = 'draft', $suffix = ' (copy)') {
    ...
    do_action('crmpn_after_post_duplication', $new_post_id, $post_id);
