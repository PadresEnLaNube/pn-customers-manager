 ...
 */
class CUSTOMERS_MANAGER_PN_i18n {
	/**
	 * Load the plugin text domain for translation.
	 *
	 * @since    1.0.0
	 */
	public function customers_manager_pn_load_plugin_textdomain() {
	...
	public function customers_manager_pn_pll_get_post_types($post_types, $is_settings) {
    if ($is_settings){
        unset($post_types['customers_manager_pn_recipe']);
    } else {
        $post_types['customers_manager_pn_recipe'] = 'customers_manager_pn_recipe';
    }

    return $post_types;
  }

  public function customers_manager_pn_timestamp_server_gap() {
  ...
  public static function customers_manager_pn_get_post($post_id) {
  	// CUSTOMERS_MANAGER_PN_i18n::customers_manager_pn_get_post($post_id);
  ...
  public static function customers_manager_pn_get_term($term_id) {
  	// CUSTOMERS_MANAGER_PN_i18n::customers_manager_pn_get_term($term_id);
