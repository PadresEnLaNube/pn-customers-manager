...
class cm_pn_forms {
  ...
  public static function customers_manager_pn_input_wrapper_builder($input_array, $type, $customers_manager_pn_id = 0, $disabled = 0, $cm_pn_format = 'half'){
    ?>
   ...
   */
  public static function customers_manager_pn_input_display_wrapper($input_array, $type, $customers_manager_pn_id = 0, $customers_manager_pn_meta_array = 0, $customers_manager_pn_array_index = 0, $cm_pn_format = 'half') {
    ob_start();
    ?>
    <?php if (array_key_exists('section', $input_array) && !empty($input_array['section'])): ?>      
      <?php if ($input_array['section'] == 'start'): ?>
    ...
    <?php else: ?>
      <div class="customers-manager-pn-input-wrapper <?php echo esc_attr($input_array['id']); ?> customers-manager-pn-input-display-<?php echo esc_attr($input_array['input']); ?> <?php echo (!empty($input_array['required']) && $input_array['required'] == true) ? 'customers-manager-pn-input-field-required' : ''; ?> customers-manager-pn-mb-30">
        <?php if (array_key_exists('label', $input_array) && !empty($input_array['label'])): ?>
          <div class="customers-manager-pn-display-inline-table <?php echo ($cm_pn_format == 'half' ? 'customers-manager-pn-width-40-percent' : 'customers-manager-pn-width-100-percent'); ?> customers-manager-pn-tablet-display-block customers-manager-pn-tablet-width-100-percent customers-manager-pn-vertical-align-top">
            <div class="customers-manager-pn-p-10 <?php echo (array_key_exists('parent', $input_array) && !empty($input_array['parent']) && $input_array['parent'] != 'this') ? 'customers-manager-pn-pl-30' : ''; ?>">
        ...
        <div class="customers-manager-pn-display-inline-table <?php echo ((array_key_exists('label', $input_array) && empty($input_array['label'])) ? 'customers-manager-pn-width-100-percent' : ($cm_pn_format == 'half' ? 'customers-manager-pn-width-60-percent' : 'customers-manager-pn-width-100-percent')); ?> customers-manager-pn-tablet-display-block customers-manager-pn-tablet-width-100-percent customers-manager-pn-vertical-align-top">
          <div class="customers-manager-pn-p-10 <?php echo (array_key_exists('parent', $input_array) && !empty($input_array['parent']) && $input_array['parent'] != 'this') ? 'customers-manager-pn-pl-30' : ''; ?>">
