 ...
 */
class CUSTOMERS_MANAGER_PN_Functions_Post {
	/**
	 ...
	 * @since    1.0.0
	 */
	public function customers_manager_pn_insert_post($title, $content, $excerpt, $name, $type, $status, $author = 1, $parent = 0, $cats = [], $tags = [], $postmeta = [], $overwrite_id = true) {
    $post_values = [
   ...
   */
  public function customers_manager_pn_duplicate_post($post_id, $post_status = 'draft', $suffix = ' (copy)') {
    ...
    do_action('customers_manager_pn_after_post_duplication', $new_post_id, $post_id);
