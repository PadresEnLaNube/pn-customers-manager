...
class CUSTOMERS_MANAGER_PN_Ajax {
  ...
  public function customers_manager_pn_ajax_server() {
    if (array_key_exists('customers_manager_pn_ajax_type', $_POST)) {
      ...
      $customers_manager_pn_ajax_type = cm_pn_forms::customers_manager_pn_sanitizer(wp_unslash($_POST['customers_manager_pn_ajax_type']));
      ...
      $cm_pn_funnel_id = !empty($_POST['cm_pn_funnel_id']) ? cm_pn_forms::customers_manager_pn_sanitizer(wp_unslash($_POST['cm_pn_funnel_id'])) : 0;
      $cm_pn_org_id = !empty($_POST['cm_pn_org_id']) ? cm_pn_forms::customers_manager_pn_sanitizer(wp_unslash($_POST['cm_pn_org_id'])) : 0;
      ...
      switch ($customers_manager_pn_ajax_type) {
        ...
        case 'cm_pn_funnel_duplicate':
          if (!empty($cm_pn_funnel_id)) {
            ...
            $plugin_post_type_post->customers_manager_pn_duplicate_post($cm_pn_funnel_id, 'publish');
        ...
        case 'cm_pn_org_duplicate':
          if (!empty($cm_pn_org_id)) {
            $plugin_post_type_post = new CUSTOMERS_MANAGER_PN_Functions_Post();
            $plugin_post_type_post->customers_manager_pn_duplicate_post($cm_pn_org_id, 'publish');
