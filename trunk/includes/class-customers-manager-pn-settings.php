...
class CUSTOMERS_MANAGER_PN_Settings {
  public function customers_manager_pn_get_options() {
    ...
    if (current_user_can('edit_cm_pn_funnel')) {
      add_submenu_page(
        'customers_manager_pn_options',
        esc_html__('Funnels', 'customers-manager-pn'),
        esc_html__('Funnels', 'customers-manager-pn'),
        'edit_cm_pn_funnel',
    ...
    if (current_user_can('edit_cm_pn_org')) {
      add_submenu_page(
        'customers_manager_pn_options',
        esc_html__('Organizations', 'customers-manager-pn'),
        esc_html__('Organizations', 'customers-manager-pn'),
        'edit_cm_pn_org',
        ...
        <div class="customers-manager-pn-options-fields customers-manager-pn-mb-30">
          ...
          <?php 
            ...
            foreach ($options as $customers_manager_pn_option) {
              cm_pn_forms::customers_manager_pn_input_wrapper_builder($customers_manager_pn_option, 'option', 0, 0, 'half');
            }
          ?>
          </form> 
        </div>
  ...
  public function customers_manager_pn_activated_plugin($plugin) {
    if($plugin == 'customers-manager-pn/customers-manager-pn.php') {
