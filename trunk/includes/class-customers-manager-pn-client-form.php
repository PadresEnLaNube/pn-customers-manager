...
class CUSTOMERS_MANAGER_PN_Client_Form {
  ...
  public function register_block() {
    ...
    register_block_type('customers-manager-pn/client-form', [
  ...
  /**
   * Hook into cm_pn_form_save to persist client data.
   *
    ...
    <div class="customers-manager-pn-client-form-wrapper">
      ...
      <form id="<?php echo esc_attr($form_id); ?>" class="customers-manager-pn-form customers-manager-pn-client-form" method="post" novalidate>
        <?php foreach ($fields as $field): ?>
          <?php echo wp_kses(cm_pn_forms::customers_manager_pn_input_wrapper_builder($field, 'post', 0, 0, 'full'), CUSTOMERS_MANAGER_PN_KSES); ?>
        <?php endforeach; ?>
      </form>
    </div>
    <?php
