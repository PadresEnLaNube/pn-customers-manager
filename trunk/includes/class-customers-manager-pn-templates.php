 ...
 */
class CUSTOMERS_MANAGER_PN_Templates {
	/**
	 * Load the plugin templates.
	 *
	 * @since    1.0.0
	...
	public function load_plugin_templates() {
		require_once CUSTOMERS_MANAGER_PN_DIR . 'templates/customers-manager-pn-footer.php';
		require_once CUSTOMERS_MANAGER_PN_DIR . 'templates/customers-manager-pn-popups.php';
	}
}