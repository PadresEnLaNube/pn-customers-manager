...
class CUSTOMERS_MANAGER_PN_Common {
    ...
    if (!wp_style_is($this->plugin_name . '-owl', 'enqueued')) {
		...
		wp_enqueue_style($this->plugin_name, CUSTOMERS_MANAGER_PN_URL . 'assets/css/customers-manager-pn.css', [], $this->version, 'all');
	}
    ...
    if(!wp_script_is($this->plugin_name . '-owl', 'enqueued')) {
		...
		wp_enqueue_script($this->plugin_name, CUSTOMERS_MANAGER_PN_URL . 'assets/js/customers-manager-pn.js', ['jquery'], $this->version, false, ['in_footer' => true, 'strategy' => 'defer']);
		...
		if ($nonce_verified) {
			$customers_manager_pn_action = !empty($_GET['customers_manager_pn_action']) ? cm_pn_forms::customers_manager_pn_sanitizer(wp_unslash($_GET['customers_manager_pn_action'])) : '';
			$customers_manager_pn_btn_id = !empty($_GET['customers_manager_pn_btn_id']) ? cm_pn_forms::customers_manager_pn_sanitizer(wp_unslash($_GET['customers_manager_pn_btn_id'])) : '';
			$customers_manager_pn_popup = !empty($_GET['customers_manager_pn_popup']) ? cm_pn_forms::customers_manager_pn_sanitizer(wp_unslash($_GET['customers_manager_pn_popup'])) : '';
			$customers_manager_pn_tab = !empty($_GET['customers_manager_pn_tab']) ? cm_pn_forms::customers_manager_pn_sanitizer(wp_unslash($_GET['customers_manager_pn_tab'])) : '';
		}
