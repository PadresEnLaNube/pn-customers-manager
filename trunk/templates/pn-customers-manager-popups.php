...
<?php foreach (PN_CUSTOMERS_MANAGER_CPTS as $PN_CUSTOMERS_MANAGER_cpt => $PN_CUSTOMERS_MANAGER_cpt_name) : ?>
  ...
  <div id="pn-customers-manager-popup-<?php echo esc_attr($PN_CUSTOMERS_MANAGER_cpt); ?>-edit" class="pn-customers-manager-popup pn-customers-manager-popup-size-large pn-customers-manager-display-none-soft" data-pn-customers-manager-popup-disable-esc="true" data-pn-customers-manager-popup-disable-overlay-close="true">
    <?php PN_CUSTOMERS_MANAGER_Data::PN_CUSTOMERS_MANAGER_popup_loader(); ?>
  </div>
