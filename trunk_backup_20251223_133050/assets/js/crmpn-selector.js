(function($) {
    ...
    class CUSTOMERS_MANAGER_PN_Selector {
        ...
        createStructure() {
            const wrapper = $('<div class="customers-manager-pn-selector"></div>');
            const control = $('<div class="customers-manager-pn-selector__control"></div>');
            const valueContainer = $('<div class="customers-manager-pn-selector__value-container"></div>');
            const input = $('<input type="text" class="customers-manager-pn-selector__input" />');
            const indicator = $('<span class="customers-manager-pn-selector__indicator"><i class="material-icons-outlined customers-manager-pn-selector__indicator-icon">keyboard_arrow_down</i></span>');
            
            valueContainer.append(input);
            control.append(valueContainer, indicator);
            wrapper.append(control);
            
            this.menu = $('<div class="customers-manager-pn-selector__menu" style="display: none;"></div>');
            
            if (this.options.searchable) {
                const searchContainer = $('<div class="customers-manager-pn-selector__search"></div>');
            ...
            this.optionsContainer = $('<div class="customers-manager-pn-selector__options"></div>');
        ...
        bindEvents() {
            ...
            this.menu.on('click', '.customers-manager-pn-selector__option', (e) => {
        ...
        openMenu() {
            ...
            this.wrapper.find('.customers-manager-pn-selector__indicator-icon').text('keyboard_arrow_up');
        ...
        closeMenu() {
            ...
            this.wrapper.find('.customers-manager-pn-selector__indicator-icon').text('keyboard_arrow_down');
        }
        ...
        updateOptions() {
            ...
            options.each((_, option) => {
                ...
                const optionElement = $('<div class="customers-manager-pn-selector__option"></div>')
                    .text(label)
                    .data('value', value);
        ...
        filterOptions(searchTerm) {
            const options = this.optionsContainer.find('.customers-manager-pn-selector__option');
        ...
        addSelectedValue(value, label) {
            ...
            this.valueContainer.find('.customers-manager-pn-selector__placeholder').remove();
            if (this.options.multiple) {
                const valueElement = $('<div class="customers-manager-pn-selector__multi-value"></div>');
                const labelElement = $('<span class="customers-manager-pn-selector__multi-value__label"></span>').text(label);
                const removeButton = $('<span class="customers-manager-pn-selector__multi-value__remove"><i class="material-icons-outlined customers-manager-pn-icon-close">close</i></span>');
                ...
                removeButton.on('click', (e) => {
                    ...
                    this.optionsContainer.find('.customers-manager-pn-selector__option').each(function() {
                ...
                const valueElement = $('<span class="customers-manager-pn-selector__single-value"></span>');
                const labelElement = $('<span class="customers-manager-pn-selector__single-value__label"></span>').text(label);
                const removeButton = $('<span class="customers-manager-pn-selector__single-value__remove"><i class="material-icons-outlined customers-manager-pn-icon-close">close</i></span>');
                removeButton.on('click', (e) => {
                    e.stopPropagation();
                    // Clear selection
                    this.selectedValues = [];
                    ...
                    if (this.placeholder) {
                        this.input.hide();
                        this.valueContainer.append('<span class="customers-manager-pn-selector__placeholder">' + this.placeholder + '</span>');
                    }
                });
                valueElement.append(labelElement, removeButton);
                this.valueContainer.append(valueElement);
    ...
    $.fn.CUSTOMERS_MANAGER_PN_Selector = function(options) {
        return this.each(function() {
            if (!$(this).data('-selector')) {
                $(this).data('-selector', new CUSTOMERS_MANAGER_PN_Selector(this, options));
            }
        });
    };
